...
describe("profilerConfigurationXml", () => {
  it("matches the DataContract serialization of a real ProfilerConfiguration", () => {
    ...
    expect(xml).toBe(
      `<Configuration xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><AssemblyId xmlns:d2p1="http://schemas.microsoft.com/xrm/2011/Contracts" i:nil="true" /><Configuration>original-unsecure-config</Configuration><EventHandler xmlns:d2p1="http://schemas.microsoft.com/xrm/2011/Contracts"><d2p1:Id>${TYPE_ID}</d2p1:Id><d2p1:KeyAttributes xmlns:d3p1="http://schemas.microsoft.com/xrm/7.1/Contracts" xmlns:d3p2="http://schemas.datacontract.org/2004/07/System.Collections.Generic" /><d2p1:LogicalName>plugintype</d2p1:LogicalName><d2p1:Name i:nil="true" /><d2p1:RowVersion i:nil="true" /></EventHandler><IncludeSecureInformation i:nil="true" /><IsContextReplay i:nil="true" /><IsProfilePersistedToEntity>true</IsProfilePersistedToEntity><MaxNumberOfExecutions i:nil="true" /><OriginalEventHandlerName>Contoso.AccountPlugin</OriginalEventHandlerName><PersistenceSessionKey>session-key-guid</PersistenceSessionKey><TypeName>Contoso.AccountPlugin</TypeName><WorkflowStepId i:nil="true" /></Configuration>`,
    );
  });
