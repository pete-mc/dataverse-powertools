...
- **Debugging** — the plugin card's **Profile next run** captures a live plug-in execution (one click on Windows) and replays it as a unit test you F5-debug in VS Code; **Debug Web Resources (local)** hot-reloads your local bundle inside the live app with breakpoints.
