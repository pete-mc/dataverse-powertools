...
- **Debugging** — the plugin card replays a captured profile as a unit test you F5-debug in VS Code; **Debug Web Resources (local)** hot-reloads your local bundle inside the live app with breakpoints.
